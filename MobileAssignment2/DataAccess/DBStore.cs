            ...
            try
            {
                using (SQLiteConnection cxn = new SQLiteConnection(DBLocation))
                {
                    ...
                    if(quizAddingQuery.Count()==0)
                    {
                        ...
                        cxn.Insert(new Quiz("Which two counties were engaged in the first Opium War", "First opium war", "China and Britain", "China and France", "China and Egypt", QuizCategory.General_Knowledge));
